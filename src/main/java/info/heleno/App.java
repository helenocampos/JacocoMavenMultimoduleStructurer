...
public class App
{
    ...
    public static void main(String[] args)
    {
        if (args.length > 0)
        {
            ...
            List<String> modulesArtifactId = new LinkedList<>();
            ...
            if (modulesFoldersName != null && !modulesFoldersName.isEmpty())
            {
                for (String moduleFolderName : modulesFoldersName)
                {
                    ...
                    if (moduleFolder.exists())
                    {
                        ...
                        if (modulePom != null)
                        {
                            modulesArtifactId.add(modulePom.getArtifactId());
                ...
                Model aggregatorModel = getAggregatorModelPom(parentPom.getArtifactId(),
                        parentPom.getVersion(), parentPom.getGroupId(), modulesArtifactId, groupIdModule);
    ...
    public static Model getAggregatorModelPom(String parentId, String parentVersion, String parentGroupId, List<String> dependencies, String moduleGroupId)
    {
